...
LOCAL_CFLAGS :=  	-fPIC -pthread -ldl -Wl,--no-as-needed -Wl,-soname=libproxychains4.so \
				   				...
				   				-I$(LOCAL_PATH)/libancillary \
									-DLIB_DIR=\"/data/user/0/in.zhaoj.shadowsocksrr_shadow/lib\" -DINSTALL_PREFIX=\"/data/user/0/in.zhaoj.shadowsocksrr_shadow/\" \
									-DDLL_NAME=\"libproxychains4.so\" -DSYSCONFDIR=\"/data/user/0/in.zhaoj.shadowsocksrr_shadow/\"
